...
const Home = () => {
  return(
    <div className="home-main">
      <h1>This is anecdotes application</h1>
    </div>
  )
}
...
const Anecdote = ({ anecdote }) => {
  ...
  return(
    <div className="anecdote">
      ...
      <p className="anecdote-footer">
        Url for more info: {anecdote.info} <br/>
...
const CreateNew = (props) => {
  console.log("HELLLOOOO", props.notification)
...
const App = () => {
  ...
  const Addition = withRouter(CreateNew)
  ...
  return (
    <div className="container">
      ...
      <Router>
        ...
        <Route exact path="/anecdotes" render={()=><AnecdoteList anecdotes={anecdotes} notification={notification} />}/>
        <Route exact path="/anecdotes/:id" render={({match})=><Anecdote anecdote={anecdoteById(match.params.id)}/>}/>
        <Route exact path="/about" render={()=><About />}/>
        <Route exact path="/create-new" render={()=><Addition addNew={addNew}/>}/>  
      </Router>
      <Footer />
    </div>
  )
